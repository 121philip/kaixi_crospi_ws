...
protected:
        ...
        double              time_scale;         ///< to scale the feedforward.
        ...
        std::string         msgbuf;             ///< Buffer to store error messages.

        /// @}
public:
    /** see also the common error codes in solver.hpp and the errorcodes of the underlying 
     *  numerical solver in qpoases_messages 
     **/
    enum ErrorCode {
        SUCCESS = 0,  // for ease of reference, also defined in solver.hpp 
        BEFORE_FIRST_ERROR_CODE = 200,
        NR_OF_PRIORITIES_NOT_SUPPORTED = 201,
        AFTER_LAST_ERROR_CODE = 202
    };
