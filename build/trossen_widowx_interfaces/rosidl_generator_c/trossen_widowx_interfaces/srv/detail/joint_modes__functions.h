...
#ifndef TROSSEN_WIDOWX_INTERFACES__SRV__DETAIL__JOINT_MODES__FUNCTIONS_H_
#define TROSSEN_WIDOWX_INTERFACES__SRV__DETAIL__JOINT_MODES__FUNCTIONS_H_
...
/// Initialize srv/JointModes message.
/**
...
/// Finalize srv/JointModes message.
/**
...
/// Create srv/JointModes message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trossen_widowx_interfaces__srv__JointModes_Request__init().
...
/// Destroy srv/JointModes message.
/**
 * It calls
 * trossen_widowx_interfaces__srv__JointModes_Request__fini()
...
/// Check for srv/JointModes message equality.
/**
...
/// Initialize array of srv/JointModes messages.
/**
...
/// Finalize array of srv/JointModes messages.
/**
 * It calls
 * trossen_widowx_interfaces__srv__JointModes_Request__fini()
...
/// Create array of srv/JointModes messages.
/**
 * It allocates the memory for the array and calls
 * trossen_widowx_interfaces__srv__JointModes_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/JointModes messages.
/**
 * It calls
 * trossen_widowx_interfaces__srv__JointModes_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/JointModes message array equality.
/**
...
/// Copy an array of srv/JointModes messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trossen_widowx_interfaces__srv__JointModes_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trossen_widowx_interfaces
...
/**
 * It calls
 * trossen_widowx_interfaces__srv__JointModes_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_trossen_widowx_interfaces
...
/**
 * It allocates the memory for the array and calls
 * trossen_widowx_interfaces__srv__JointModes_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trossen_widowx_interfaces
...
/**
 * It calls
 * trossen_widowx_interfaces__srv__JointModes_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TROSSEN_WIDOWX_INTERFACES__SRV__DETAIL__JOINT_MODES__FUNCTIONS_H_
