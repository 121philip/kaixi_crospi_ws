...
#ifndef TROSSEN_WIDOWX_INTERFACES__SRV__DETAIL__ARM_MODE__FUNCTIONS_H_
#define TROSSEN_WIDOWX_INTERFACES__SRV__DETAIL__ARM_MODE__FUNCTIONS_H_
...
/// Initialize srv/ArmMode message.
/**
...
/// Create srv/ArmMode message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trossen_widowx_interfaces__srv__ArmMode_Request__init().
...
/// Destroy srv/ArmMode message.
/**
 * It calls
 * trossen_widowx_interfaces__srv__ArmMode_Request__fini()
...
/// Check for srv/ArmMode message equality.
/**
...
/// Initialize array of srv/ArmMode messages.
/**
...
/// Finalize array of srv/ArmMode messages.
/**
 * It calls
 * trossen_widowx_interfaces__srv__ArmMode_Request__fini()
...
/// Create array of srv/ArmMode messages.
/**
 * It allocates the memory for the array and calls
 * trossen_widowx_interfaces__srv__ArmMode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArmMode messages.
/**
 * It calls
 * trossen_widowx_interfaces__srv__ArmMode_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArmMode message array equality.
/**
...
/// Copy an array of srv/ArmMode messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * trossen_widowx_interfaces__srv__ArmMode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trossen_widowx_interfaces
...
/**
 * It calls
 * trossen_widowx_interfaces__srv__ArmMode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_trossen_widowx_interfaces
...
/**
 * It allocates the memory for the array and calls
 * trossen_widowx_interfaces__srv__ArmMode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_trossen_widowx_interfaces
...
/**
 * It calls
 * trossen_widowx_interfaces__srv__ArmMode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TROSSEN_WIDOWX_INTERFACES__SRV__DETAIL__ARM_MODE__FUNCTIONS_H_
