...
#include "crospi_interfaces/msg/detail/test__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const crospi_interfaces::msg::Test & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  crospi_interfaces::msg::Test & ros_message)
{
  // Member: a
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crospi_interfaces::msg::Test;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const crospi_interfaces::msg::Test *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crospi_interfaces::msg::Test *>(
    untyped_ros_message);
...
{
  return &crospi_interfaces::msg::typesupport_fastrtps_cpp::_Test__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crospi_interfaces, msg, Test)() {
  return &crospi_interfaces::msg::typesupport_fastrtps_cpp::_Test__handle;
}
