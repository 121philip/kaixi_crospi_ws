...
#include "crospi_interfaces/msg/detail/input__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crospi_interfaces::msg::Input;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crospi_interfaces::msg::Input *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crospi_interfaces::msg::Input *>(
    untyped_ros_message);
...
{
  return &crospi_interfaces::msg::typesupport_fastrtps_cpp::_Input__handle;
}
