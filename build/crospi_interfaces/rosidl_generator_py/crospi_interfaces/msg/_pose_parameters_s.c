...
bool crospi_interfaces__msg__pose_parameters__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crospi_interfaces.msg._pose_parameters.PoseParameters", full_classname_dest, 53) == 0);
  }
  crospi_interfaces__msg__PoseParameters * ros_message = _ros_message;
  {  // name
  ...
  {  // poses
    ...
    if (!geometry_msgs__msg__transform__convert_from_py(field, &ros_message->poses)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PoseParameters */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crospi_interfaces.msg._pose_parameters");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseParameters");
  ...
  {  // poses
    PyObject * field = NULL;
    field = geometry_msgs__msg__transform__convert_to_py(&ros_message->poses);
    if (!field) {
      return NULL;
    }
    {
