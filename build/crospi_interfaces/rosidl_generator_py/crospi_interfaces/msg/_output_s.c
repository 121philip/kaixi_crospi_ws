...
bool crospi_interfaces__msg__output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crospi_interfaces.msg._output.Output", full_classname_dest, 36) == 0);
  }
  crospi_interfaces__msg__Output * ros_message = _ros_message;
  {  // names
...
PyObject * crospi_interfaces__msg__output__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("crospi_interfaces.msg._output");
