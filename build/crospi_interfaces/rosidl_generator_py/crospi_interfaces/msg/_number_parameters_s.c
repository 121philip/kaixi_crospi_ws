...
bool crospi_interfaces__msg__number_parameters__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crospi_interfaces.msg._number_parameters.NumberParameters", full_classname_dest, 57) == 0);
  }
  crospi_interfaces__msg__NumberParameters * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of NumberParameters */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("crospi_interfaces.msg._number_parameters");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NumberParameters");
