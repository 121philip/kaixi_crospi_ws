...
bool crospi_interfaces__msg__input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crospi_interfaces.msg._input.Input", full_classname_dest, 34) == 0);
  }
  crospi_interfaces__msg__Input * ros_message = _ros_message;
  {  // names
...
PyObject * crospi_interfaces__msg__input__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("crospi_interfaces.msg._input");
