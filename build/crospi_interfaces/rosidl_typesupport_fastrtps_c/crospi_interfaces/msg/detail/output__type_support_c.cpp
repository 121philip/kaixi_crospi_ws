...
#include "crospi_interfaces/msg/detail/output__rosidl_typesupport_fastrtps_c.h"
...
using _Output__ros_msg_type = crospi_interfaces__msg__Output;
...
static uint32_t _Output__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crospi_interfaces__msg__Output(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crospi_interfaces__msg__Output;
    is_plain =
      (
...
static size_t _Output__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crospi_interfaces__msg__Output(
