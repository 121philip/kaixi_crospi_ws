...
#include "crospi_interfaces/msg/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test__ros_msg_type = crospi_interfaces__msg__Test;
...
size_t get_serialized_size_crospi_interfaces__msg__Test(
  const void * untyped_ros_message,
...
static uint32_t _Test__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crospi_interfaces__msg__Test(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crospi_interfaces
size_t max_serialized_size_crospi_interfaces__msg__Test(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crospi_interfaces__msg__Test;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
static size_t _Test__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crospi_interfaces__msg__Test(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crospi_interfaces, msg, Test)() {
