...
#include "crospi_interfaces/msg/detail/number_parameters__rosidl_typesupport_fastrtps_c.h"
...
using _NumberParameters__ros_msg_type = crospi_interfaces__msg__NumberParameters;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NumberParameters__ros_msg_type * ros_message = static_cast<const _NumberParameters__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NumberParameters__ros_msg_type * ros_message = static_cast<_NumberParameters__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _NumberParameters__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crospi_interfaces__msg__NumberParameters(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crospi_interfaces__msg__NumberParameters;
    is_plain =
      (
...
static size_t _NumberParameters__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crospi_interfaces__msg__NumberParameters(
...
static message_type_support_callbacks_t __callbacks_NumberParameters = {
...
static rosidl_message_type_support_t _NumberParameters__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NumberParameters,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crospi_interfaces, msg, NumberParameters)() {
  return &_NumberParameters__type_support;
}
