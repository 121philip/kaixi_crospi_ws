...
{
  new (message_memory) crospi_interfaces::msg::Test(_init);
}

void Test_fini_function(void * message_memory)
{
  auto typed_message = static_cast<crospi_interfaces::msg::Test *>(message_memory);
  typed_message->~Test();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_message_member_array[1] = {
  {
    ...
    offsetof(crospi_interfaces::msg::Test, a),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_message_members = {
  ...
  "Test",  // message name
  1,  // number of fields
  sizeof(crospi_interfaces::msg::Test),
...
{
  return &::crospi_interfaces::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crospi_interfaces, msg, Test)() {
  return &::crospi_interfaces::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
