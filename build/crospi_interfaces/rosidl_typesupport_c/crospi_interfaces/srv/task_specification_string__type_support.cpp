...
static const _TaskSpecificationString_Request_type_support_symbol_names_t _TaskSpecificationString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crospi_interfaces, srv, TaskSpecificationString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crospi_interfaces, srv, TaskSpecificationString_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, crospi_interfaces, srv, TaskSpecificationString_Request)() {
  return &::crospi_interfaces::srv::rosidl_typesupport_c::TaskSpecificationString_Request_message_type_support_handle;
}
...
static const _TaskSpecificationString_Response_type_support_symbol_names_t _TaskSpecificationString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crospi_interfaces, srv, TaskSpecificationString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crospi_interfaces, srv, TaskSpecificationString_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, crospi_interfaces, srv, TaskSpecificationString_Response)() {
  return &::crospi_interfaces::srv::rosidl_typesupport_c::TaskSpecificationString_Response_message_type_support_handle;
}
...
static const _TaskSpecificationString_type_support_symbol_names_t _TaskSpecificationString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crospi_interfaces, srv, TaskSpecificationString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crospi_interfaces, srv, TaskSpecificationString)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, crospi_interfaces, srv, TaskSpecificationString)() {
  return &::crospi_interfaces::srv::rosidl_typesupport_c::TaskSpecificationString_service_type_support_handle;
}
