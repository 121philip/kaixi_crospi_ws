...
static const _PoseParameters_type_support_symbol_names_t _PoseParameters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crospi_interfaces, msg, PoseParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crospi_interfaces, msg, PoseParameters)),
  }
};
...
{
  return &::crospi_interfaces::msg::rosidl_typesupport_cpp::PoseParameters_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crospi_interfaces, msg, PoseParameters)() {
  return get_message_type_support_handle<crospi_interfaces::msg::PoseParameters>();
}
