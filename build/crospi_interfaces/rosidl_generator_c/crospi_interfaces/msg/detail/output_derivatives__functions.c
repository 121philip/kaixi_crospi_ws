...
crospi_interfaces__msg__OutputDerivatives__init(crospi_interfaces__msg__OutputDerivatives * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->names, 0)) {
    crospi_interfaces__msg__OutputDerivatives__fini(msg);
    return false;
  }
  // data
...
crospi_interfaces__msg__OutputDerivatives__create()
{
  ...
  crospi_interfaces__msg__OutputDerivatives * msg = (crospi_interfaces__msg__OutputDerivatives *)allocator.allocate(sizeof(crospi_interfaces__msg__OutputDerivatives), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(crospi_interfaces__msg__OutputDerivatives));
  bool success = crospi_interfaces__msg__OutputDerivatives__init(msg);
  if (!success) {
...
crospi_interfaces__msg__OutputDerivatives__Sequence__init(crospi_interfaces__msg__OutputDerivatives__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crospi_interfaces__msg__OutputDerivatives * data = NULL;

  if (size) {
    data = (crospi_interfaces__msg__OutputDerivatives *)allocator.zero_allocate(size, sizeof(crospi_interfaces__msg__OutputDerivatives), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = crospi_interfaces__msg__OutputDerivatives__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        crospi_interfaces__msg__OutputDerivatives__fini(&data[i - 1]);
      }
...
crospi_interfaces__msg__OutputDerivatives__Sequence__fini(crospi_interfaces__msg__OutputDerivatives__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      crospi_interfaces__msg__OutputDerivatives__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crospi_interfaces__msg__OutputDerivatives__Sequence * array = (crospi_interfaces__msg__OutputDerivatives__Sequence *)allocator.allocate(sizeof(crospi_interfaces__msg__OutputDerivatives__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = crospi_interfaces__msg__OutputDerivatives__Sequence__init(array, size);
  if (!success) {
...
crospi_interfaces__msg__OutputDerivatives__Sequence__destroy(crospi_interfaces__msg__OutputDerivatives__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    crospi_interfaces__msg__OutputDerivatives__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
crospi_interfaces__msg__OutputDerivatives__Sequence__are_equal(const crospi_interfaces__msg__OutputDerivatives__Sequence * lhs, const crospi_interfaces__msg__OutputDerivatives__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!crospi_interfaces__msg__OutputDerivatives__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  crospi_interfaces__msg__OutputDerivatives__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(crospi_interfaces__msg__OutputDerivatives);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    crospi_interfaces__msg__OutputDerivatives * data =
      (crospi_interfaces__msg__OutputDerivatives *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crospi_interfaces__msg__OutputDerivatives__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          crospi_interfaces__msg__OutputDerivatives__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!crospi_interfaces__msg__OutputDerivatives__copy(
